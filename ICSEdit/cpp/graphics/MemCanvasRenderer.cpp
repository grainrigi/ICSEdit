...
void ICSE::graphics::MemCanvasRenderer::RegisterElement(MemTexturedCanvasRGBA8 & canvas, const wnd::BoundingBox & bbox, bool autoclip)
{
...
void ICSE::graphics::MemCanvasRenderer::RenderAll(DrawEnv *env)
{
	for (auto &dunit : m_dunits)
		dunit.second.DrawRegistered(env, *this);
}

void ICSE::graphics::MemCanvasRenderer::initShader(void)
{
...
void ICSE::graphics::MemCanvasRenderer::DrawUnit::RegisterElement(int spaceid, int texwidth, int texheight, const wnd::BoundingBox & bbox)
{
...
void ICSE::graphics::MemCanvasRenderer::DrawUnit::DrawRegistered(DrawEnv *env, const MemCanvasRenderer &parent)
{
	Matrix4f mat;
