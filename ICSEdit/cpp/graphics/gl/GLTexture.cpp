...
using ICSE::graphics::gl::GLTexture;
using ICSE::file::ImageFile;

ICSE::graphics::gl::GLTexture::GLTexture(bool init)
	: m_texture(0)
{
	if(init)
		this->init();
...
ICSE::graphics::gl::GLTexture::~GLTexture(void)
{
	if(m_texture != 0)
	{
...
bool ICSE::graphics::gl::GLTexture::uploadImage(const file::ImageFile & img)
{
