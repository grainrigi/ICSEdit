...
void ICSE::graphics::MemCanvasRenderTexturePool::TextureUnit::ReleaseSpace(int spaceid)
{
	uint8_t *map = m_map;
...
void ICSE::graphics::MemCanvasRenderTexturePool::TextureUnit::UpdateTexture(int spaceid, const MemCanvasRGBA8 & canvas)
{
...
MemTexturedCanvasRGBA8 ICSE::graphics::MemCanvasRenderTexturePool::ObtainCanvas(int width, int height)
{
...
{
	static std::atomic_uint32_t ctr(0);
